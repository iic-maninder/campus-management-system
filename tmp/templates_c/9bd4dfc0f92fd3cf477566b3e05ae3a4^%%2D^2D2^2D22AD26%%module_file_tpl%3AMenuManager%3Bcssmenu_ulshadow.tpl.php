...
<?php $this->_cache_serials['D:\wamp\www\cms\tmp\templates_c\9bd4dfc0f92fd3cf477566b3e05ae3a4^%%2D^2D2^2D22AD26%%module_file_tpl%3AMenuManager%3Bcssmenu_ulshadow.tpl.inc'] = '37ea13e00beae9f4b4ba9bcc1458c153'; ?>
...
<?php if ($this->_tpl_vars['node']->depth > $this->_tpl_vars['node']->prevdepth): ?>
  <?php if ($this->caching && !$this->_cache_including): echo '{nocache:37ea13e00beae9f4b4ba9bcc1458c153#0}'; endif;$_cache_attrs =& $this->_smarty_cache_attrs('37ea13e00beae9f4b4ba9bcc1458c153','0');echo smarty_cms_function_repeat(array('string' => '<ul class="unli">','times' => $this->_tpl_vars['node']->depth-$this->_tpl_vars['node']->prevdepth), $this);if ($this->caching && !$this->_cache_including): echo '{/nocache:37ea13e00beae9f4b4ba9bcc1458c153#0}'; endif;?>

<?php elseif ($this->_tpl_vars['node']->depth < $this->_tpl_vars['node']->prevdepth): ?>
  <?php if ($this->caching && !$this->_cache_including): echo '{nocache:37ea13e00beae9f4b4ba9bcc1458c153#1}'; endif;$_cache_attrs =& $this->_smarty_cache_attrs('37ea13e00beae9f4b4ba9bcc1458c153','1');echo smarty_cms_function_repeat(array('string' => '</li><li class="separator once" style="list-style-type: none;">&nbsp;</li></ul>','times' => $this->_tpl_vars['node']->prevdepth-$this->_tpl_vars['node']->depth), $this);if ($this->caching && !$this->_cache_including): echo '{/nocache:37ea13e00beae9f4b4ba9bcc1458c153#1}'; endif;?>
...
<?php if ($this->caching && !$this->_cache_including): echo '{nocache:37ea13e00beae9f4b4ba9bcc1458c153#2}'; endif;$_cache_attrs =& $this->_smarty_cache_attrs('37ea13e00beae9f4b4ba9bcc1458c153','2');echo smarty_cms_function_repeat(array('string' => '</li><li class="separator once" style="list-style-type: none;">&nbsp;</li></ul>','times' => $this->_tpl_vars['node']->depth-1), $this);if ($this->caching && !$this->_cache_including): echo '{/nocache:37ea13e00beae9f4b4ba9bcc1458c153#2}'; endif;?>
