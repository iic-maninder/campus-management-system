<?php /* Smarty version 2.6.26, created on 2012-04-11 13:29:15
         compiled from module_file_tpl:ModuleManager%3Bnewversionstab.tpl */ ?>
<?php if (! empty ( $this->_tpl_vars['updatestxt'] )): ?>
<h4><?php echo $this->_tpl_vars['updatestxt']; ?>
</h4>
<?php endif; ?>
...
<?php if (isset ( $this->_tpl_vars['itemcount'] ) && $this->_tpl_vars['itemcount'] > 0): ?>
<table cellspacing="0" class="pagetable">
	<thead>
		<tr>
			...
			<th><?php echo $this->_tpl_vars['haveversion']; ?>
</th>
...
">
			...
			<td><?php if (isset ( $this->_tpl_vars['entry']->haveversion )): ?><?php echo $this->_tpl_vars['entry']->haveversion; ?>
<?php endif; ?></td>
...
">
                	<td>&nbsp;</td>
                	<td colspan="7"><?php echo $this->_tpl_vars['entry']->description; ?>
</td>
	        </tr>
	<?php endif; ?>
...
<?php else: ?>
<p><?php echo $this->_tpl_vars['nvmessage']; ?>
</p>
<?php endif; ?>