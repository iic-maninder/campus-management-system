...
<?php $this->_cache_serials['D:\wamp\www\cms\tmp\templates_c\98f6734dc2637e1fdfc7025538d5363c^%%2D^2D2^2D22AD26%%module_file_tpl%3AMenuManager%3Bcssmenu_ulshadow.tpl.inc'] = '805339251929e42e3f75aeff83457373'; ?>
...
<?php if ($this->_tpl_vars['node']->depth > $this->_tpl_vars['node']->prevdepth): ?>
  <?php if ($this->caching && !$this->_cache_including): echo '{nocache:805339251929e42e3f75aeff83457373#0}'; endif;$_cache_attrs =& $this->_smarty_cache_attrs('805339251929e42e3f75aeff83457373','0');echo smarty_cms_function_repeat(array('string' => '<ul class="unli">','times' => $this->_tpl_vars['node']->depth-$this->_tpl_vars['node']->prevdepth), $this);if ($this->caching && !$this->_cache_including): echo '{/nocache:805339251929e42e3f75aeff83457373#0}'; endif;?>

<?php elseif ($this->_tpl_vars['node']->depth < $this->_tpl_vars['node']->prevdepth): ?>
  <?php if ($this->caching && !$this->_cache_including): echo '{nocache:805339251929e42e3f75aeff83457373#1}'; endif;$_cache_attrs =& $this->_smarty_cache_attrs('805339251929e42e3f75aeff83457373','1');echo smarty_cms_function_repeat(array('string' => '</li><li class="separator once" style="list-style-type: none;">&nbsp;</li></ul>','times' => $this->_tpl_vars['node']->prevdepth-$this->_tpl_vars['node']->depth), $this);if ($this->caching && !$this->_cache_including): echo '{/nocache:805339251929e42e3f75aeff83457373#1}'; endif;?>
...
<?php if ($this->caching && !$this->_cache_including): echo '{nocache:805339251929e42e3f75aeff83457373#2}'; endif;$_cache_attrs =& $this->_smarty_cache_attrs('805339251929e42e3f75aeff83457373','2');echo smarty_cms_function_repeat(array('string' => '</li><li class="separator once" style="list-style-type: none;">&nbsp;</li></ul>','times' => $this->_tpl_vars['node']->depth-1), $this);if ($this->caching && !$this->_cache_including): echo '{/nocache:805339251929e42e3f75aeff83457373#2}'; endif;?>
