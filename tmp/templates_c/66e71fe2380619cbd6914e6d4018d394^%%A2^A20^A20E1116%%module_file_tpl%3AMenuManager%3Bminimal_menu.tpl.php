...
<?php $this->_cache_serials['D:\wamp\www\cms\tmp\templates_c\66e71fe2380619cbd6914e6d4018d394^%%A2^A20^A20E1116%%module_file_tpl%3AMenuManager%3Bminimal_menu.tpl.inc'] = '8298fd0d533bccda0ea805f7731c3754'; ?> 
...
<?php if ($this->caching && !$this->_cache_including): echo '{nocache:8298fd0d533bccda0ea805f7731c3754#0}'; endif;$_cache_attrs =& $this->_smarty_cache_attrs('8298fd0d533bccda0ea805f7731c3754','0');echo smarty_cms_function_repeat(array('string' => "<ul>",'times' => $this->_tpl_vars['node']->depth-$this->_tpl_vars['node']->prevdepth), $this);if ($this->caching && !$this->_cache_including): echo '{/nocache:8298fd0d533bccda0ea805f7731c3754#0}'; endif;?>

<?php elseif ($this->_tpl_vars['node']->depth < $this->_tpl_vars['node']->prevdepth): ?>
<?php if ($this->caching && !$this->_cache_including): echo '{nocache:8298fd0d533bccda0ea805f7731c3754#1}'; endif;$_cache_attrs =& $this->_smarty_cache_attrs('8298fd0d533bccda0ea805f7731c3754','1');echo smarty_cms_function_repeat(array('string' => "</li></ul>",'times' => $this->_tpl_vars['node']->prevdepth-$this->_tpl_vars['node']->depth), $this);if ($this->caching && !$this->_cache_including): echo '{/nocache:8298fd0d533bccda0ea805f7731c3754#1}'; endif;?>
...
<?php if ($this->caching && !$this->_cache_including): echo '{nocache:8298fd0d533bccda0ea805f7731c3754#2}'; endif;$_cache_attrs =& $this->_smarty_cache_attrs('8298fd0d533bccda0ea805f7731c3754','2');echo smarty_cms_function_repeat(array('string' => "</li></ul>",'times' => $this->_tpl_vars['node']->depth-1), $this);if ($this->caching && !$this->_cache_including): echo '{/nocache:8298fd0d533bccda0ea805f7731c3754#2}'; endif;?>
</li>
</ul>
<?php endif; ?>