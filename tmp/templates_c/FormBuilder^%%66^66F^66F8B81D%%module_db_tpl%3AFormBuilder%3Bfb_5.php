<?php /* Smarty version 2.6.26, created on 2012-04-11 07:40:17
         compiled from module_db_tpl:FormBuilder%3Bfb_5 */ ?>
<?php require_once(SMARTY_CORE_DIR . 'core.load_plugins.php');
smarty_core_load_plugins(array('plugins' => array(array('function', 'eval', 'module_db_tpl:FormBuilder;fb_5', 87, false),)), $this); ?>
<?php $this->_cache_serials['D:\wamp\www\cms\tmp\templates_c\FormBuilder^%%66^66F^66F8B81D%%module_db_tpl%3AFormBuilder%3Bfb_5.inc'] = '5cc0a1428f21fda6be408d5ac8cb2634'; ?><?php echo '
...
?><?php echo ''; ?><?php if ($this->_tpl_vars['entry']->label_parts == 1): ?><?php echo '<div>'; ?><?php echo $this->_tpl_vars['entry']->input[$this->_sections['numloop']['index']]->input; ?><?php echo '&nbsp;'; ?><?php echo $this->_tpl_vars['entry']->input[$this->_sections['numloop']['index']]->name; ?><?php echo '</div>'; ?><?php else: ?><?php echo ''; ?><?php echo $this->_tpl_vars['entry']->input[$this->_sections['numloop']['index']]->input; ?><?php echo ''; ?><?php endif; ?><?php echo ''; ?><?php if (isset ( $this->_tpl_vars['entry']->input[$this->_sections['numloop']['index']]->op ) && $this->_tpl_vars['entry']->input[$this->_sections['numloop']['index']]->op): ?><?php echo ''; ?><?php echo $this->_tpl_vars['entry']->input[$this->_sections['numloop']['index']]->op; ?><?php echo ''; ?><?php endif; ?><?php echo ''; ?><?php endfor; endif; ?><?php echo ''; ?><?php else: ?><?php echo ''; ?><?php if ($this->_tpl_vars['entry']->smarty_eval == '1'): ?><?php echo ''; ?><?php if ($this->caching && !$this->_cache_including): echo '{nocache:5cc0a1428f21fda6be408d5ac8cb2634#0}'; endif;$_cache_attrs =& $this->_smarty_cache_attrs('5cc0a1428f21fda6be408d5ac8cb2634','0');echo smarty_function_eval(array('var' => $this->_tpl_vars['entry']->input), $this);if ($this->caching && !$this->_cache_including): echo '{/nocache:5cc0a1428f21fda6be408d5ac8cb2634#0}'; endif;?><?php echo ''; ?><?php else: ?><?php echo ''; ?><?php echo $this->_tpl_vars['entry']->input; ?><?php echo ''; ?><?php endif; ?><?php echo ''; ?><?php endif; ?><?php echo ''; ?><?php if ($this->_tpl_vars['entry']->helptext != ''): ?><?php echo '&nbsp;<a href="javascript:fbht(\''; ?><?php echo $this->_tpl_vars['entry']->field_helptext_id; ?><?php echo '\')"><img src="modules/FormBuilder/images/info-small.gif" alt="Help" /></a><span id="'; ?><?php echo $this->_tpl_vars['entry']->field_helptext_id; ?><?php echo '" style="display:none" class="fbr_helptext">'; ?><?php echo $this->_tpl_vars['entry']->helptext; ?><?php echo '</span>'; ?><?php endif; ?><?php echo ''; ?><?php if ($this->_tpl_vars['entry']->valid == 0): ?><?php echo ' &lt;--- '; ?><?php echo $this->_tpl_vars['entry']->error; ?><?php echo ''; ?><?php endif; ?><?php echo ''; ?><?php if ($this->_tpl_vars['entry']->needs_div == 1): ?><?php echo '</div>'; ?><?php endif; ?><?php echo ''; ?>
