...
<?php $this->_cache_serials['D:\wamp\www\cms\tmp\templates_c\248af2d41814040237fc9ca57e7a68e4^%%2D^2D2^2D22AD26%%module_file_tpl%3AMenuManager%3Bcssmenu_ulshadow.tpl.inc'] = '4a7f2de1506a0ed3b198280ef8ecf5c1'; ?>
...
<?php if ($this->_tpl_vars['node']->depth > $this->_tpl_vars['node']->prevdepth): ?>
  <?php if ($this->caching && !$this->_cache_including): echo '{nocache:4a7f2de1506a0ed3b198280ef8ecf5c1#0}'; endif;$_cache_attrs =& $this->_smarty_cache_attrs('4a7f2de1506a0ed3b198280ef8ecf5c1','0');echo smarty_cms_function_repeat(array('string' => '<ul class="unli">','times' => $this->_tpl_vars['node']->depth-$this->_tpl_vars['node']->prevdepth), $this);if ($this->caching && !$this->_cache_including): echo '{/nocache:4a7f2de1506a0ed3b198280ef8ecf5c1#0}'; endif;?>

<?php elseif ($this->_tpl_vars['node']->depth < $this->_tpl_vars['node']->prevdepth): ?>
  <?php if ($this->caching && !$this->_cache_including): echo '{nocache:4a7f2de1506a0ed3b198280ef8ecf5c1#1}'; endif;$_cache_attrs =& $this->_smarty_cache_attrs('4a7f2de1506a0ed3b198280ef8ecf5c1','1');echo smarty_cms_function_repeat(array('string' => '</li><li class="separator once" style="list-style-type: none;">&nbsp;</li></ul>','times' => $this->_tpl_vars['node']->prevdepth-$this->_tpl_vars['node']->depth), $this);if ($this->caching && !$this->_cache_including): echo '{/nocache:4a7f2de1506a0ed3b198280ef8ecf5c1#1}'; endif;?>
...
<?php if ($this->caching && !$this->_cache_including): echo '{nocache:4a7f2de1506a0ed3b198280ef8ecf5c1#2}'; endif;$_cache_attrs =& $this->_smarty_cache_attrs('4a7f2de1506a0ed3b198280ef8ecf5c1','2');echo smarty_cms_function_repeat(array('string' => '</li><li class="separator once" style="list-style-type: none;">&nbsp;</li></ul>','times' => $this->_tpl_vars['node']->depth-1), $this);if ($this->caching && !$this->_cache_including): echo '{/nocache:4a7f2de1506a0ed3b198280ef8ecf5c1#2}'; endif;?>
