<?php /* Smarty version 2.6.26, created on 2012-04-11 07:26:06
...
<?php $this->_cache_serials['D:\wamp\www\cms\tmp\templates_c\a16e8ecda52917bfc1a59b8e0b25b40c^%%2D^2D2^2D22AD26%%module_file_tpl%3AMenuManager%3Bcssmenu_ulshadow.tpl.inc'] = '2c4a6b8cc63e2040a9b42e2c7f2a8094'; ?>
...
<?php if ($this->_tpl_vars['node']->depth > $this->_tpl_vars['node']->prevdepth): ?>
  <?php if ($this->caching && !$this->_cache_including): echo '{nocache:2c4a6b8cc63e2040a9b42e2c7f2a8094#0}'; endif;$_cache_attrs =& $this->_smarty_cache_attrs('2c4a6b8cc63e2040a9b42e2c7f2a8094','0');echo smarty_cms_function_repeat(array('string' => '<ul class="unli">','times' => $this->_tpl_vars['node']->depth-$this->_tpl_vars['node']->prevdepth), $this);if ($this->caching && !$this->_cache_including): echo '{/nocache:2c4a6b8cc63e2040a9b42e2c7f2a8094#0}'; endif;?>

<?php elseif ($this->_tpl_vars['node']->depth < $this->_tpl_vars['node']->prevdepth): ?>
  <?php if ($this->caching && !$this->_cache_including): echo '{nocache:2c4a6b8cc63e2040a9b42e2c7f2a8094#1}'; endif;$_cache_attrs =& $this->_smarty_cache_attrs('2c4a6b8cc63e2040a9b42e2c7f2a8094','1');echo smarty_cms_function_repeat(array('string' => '</li><li class="separator once" style="list-style-type: none;">&nbsp;</li></ul>','times' => $this->_tpl_vars['node']->prevdepth-$this->_tpl_vars['node']->depth), $this);if ($this->caching && !$this->_cache_including): echo '{/nocache:2c4a6b8cc63e2040a9b42e2c7f2a8094#1}'; endif;?>
...
<?php if ($this->caching && !$this->_cache_including): echo '{nocache:2c4a6b8cc63e2040a9b42e2c7f2a8094#2}'; endif;$_cache_attrs =& $this->_smarty_cache_attrs('2c4a6b8cc63e2040a9b42e2c7f2a8094','2');echo smarty_cms_function_repeat(array('string' => '</li><li class="separator once" style="list-style-type: none;">&nbsp;</li></ul>','times' => $this->_tpl_vars['node']->depth-1), $this);if ($this->caching && !$this->_cache_including): echo '{/nocache:2c4a6b8cc63e2040a9b42e2c7f2a8094#2}'; endif;?>
