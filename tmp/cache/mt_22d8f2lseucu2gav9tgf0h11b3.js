			...
			switch (n) {
				case 'cmslinker':
					...
					c.onRenderMenu.add(function(c, m) {
						...
						mm.add({title : '7 Library', onclick : function() {
							var sel=tinyMCE.activeEditor.selection.getContent();
							if (sel=='') sel='Library';
							tinyMCE.activeEditor.execCommand('mceInsertContent', false, "<a href=\"{cms_selflink href='library'}\">"+sel+"</a>");
						}});
							mm.addSeparator();
						...
						m.add({title : '8 Cafe', onclick : function() {
							var sel=tinyMCE.activeEditor.selection.getContent();
							if (sel=='') sel='Cafe';
							tinyMCE.activeEditor.execCommand('mceInsertContent', false, "<a href=\"{cms_selflink href='cafe'}\">"+sel+"</a>");
						}});
		
						m.add({title : '9 Contact Us', onclick : function() {
							var sel=tinyMCE.activeEditor.selection.getContent();
							if (sel=='') sel='Contact Us';
							tinyMCE.activeEditor.execCommand('mceInsertContent', false, "<a href=\"{cms_selflink href='contact-us'}\">"+sel+"</a>");
						}});
		
						m.add({title : '10 Placing order', onclick : function() {
							var sel=tinyMCE.activeEditor.selection.getContent();
							if (sel=='') sel='Placing order';
							tinyMCE.activeEditor.execCommand('mceInsertContent', false, "<a href=\"{cms_selflink href='placing-order'}\">"+sel+"</a>");
						}});
							var mm = m.addMenu({title : '11 Resources'});
		
						mm.add({title : '11 Resources', onclick : function() {
							var sel=tinyMCE.activeEditor.selection.getContent();
							if (sel=='') sel='Resources';
							tinyMCE.activeEditor.execCommand('mceInsertContent', false, "<a href=\"{cms_selflink href='resources'}\">"+sel+"</a>");
						}});
							mm.addSeparator();
		
						mm.add({title : '11.1 Availability', onclick : function() {
							var sel=tinyMCE.activeEditor.selection.getContent();
							if (sel=='') sel='Availability';
							tinyMCE.activeEditor.execCommand('mceInsertContent', false, "<a href=\"{cms_selflink href='availability'}\">"+sel+"</a>");
						}});
		
						m.add({title : '12 Resource Booking', onclick : function() {
							var sel=tinyMCE.activeEditor.selection.getContent();
							if (sel=='') sel='Resource Booking';
							tinyMCE.activeEditor.execCommand('mceInsertContent', false, "<a href=\"{cms_selflink href='booking'}\">"+sel+"</a>");
						}});
...
function CMSMSFilePicker (field_name, url, type, win) {
  ...
  var cmsURL = "http://localhost/cms/modules/MicroTiny/filepicker.php?_sx_=0233018b&type="+type;
